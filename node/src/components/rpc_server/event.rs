...
use crate::{
    ...
    types::{BlockAndMetadata, BlockHash, Deploy, DeployHash, DeployMetadata, NodeId},
};
...
pub enum Event {
    ...
    GetBlockResult {
        ...
        result: Box<Option<BlockAndMetadata>>,
        main_responder: Responder<Option<BlockAndMetadata>>,
    },
